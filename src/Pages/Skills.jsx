...
const Skills = () => {
  return (
    ...
    //       <Text fontWeight={700} color={'gray'}>My Knowledge</Text>
    //     </Box>
    //     <Grid 
    //     fontSize={16}
    //      textAlign={'center'} 
    ...
    //     w={'fit-content'} 
    //     m={'auto'}>
    //       <GridItem className="skills-card" m={10} outline={'2px solid #1976d2'} p={3} borderRadius={10} style={{ boxShadow: 'rgba(0, 0, 0, 0.35) 0px 5px 15px', }} _hover={{ color: '#1976d2', cursor: 'pointer' }} >
    //         <AiOutlineHtml5  className="skills-card-img" fontSize={40} />
  ...
  <Box id="skills" w={'90%'} m={'auto'} mt={[10, 10, 2]}>
    ...
    <Grid
      ...
      textAlign={'center'}
      templateColumns={['repeat(6, 1fr)'] /* Display all items in one row */}
      gap={0}
      w={'fit-content'}
      m={'auto'}
    >
      <GridItem
        ...
        _hover={{ color: '#1976d2', cursor: 'pointer' }}
      >
        <AiOutlineHtml5 className="skills-card-img" fontSize={30} /* Reduced font size */ />
        <Text className="skills-card-name">HTML</Text>
      </GridItem>
      <GridItem
        className="skills-card"
        ...
        _hover={{ color: '#1976d2', cursor: 'pointer' }}
      >
        <SiCss3 className="skills-card-img" fontSize={40} /* Reduced font size */ />
      ...
      <GridItem
        ...
        _hover={{ color: '#1976d2', cursor: 'pointer' }}
      >
        <IoLogoJavascript className="skills-card-img" fontSize={40} /* Reduced font size */ />
        <Text className="skills-card-name">JS</Text>
      </GridItem>
      <GridItem
        className="skills-card"
        m={10}
        ...
        _hover={{ color: '#1976d2', cursor: 'pointer' }}
      >
        <FaReact className="skills-card-img" fontSize={40} /* Reduced font size */ />
      ...
      <GridItem
        ...
        _hover={{ color: '#1976d2', cursor: 'pointer' }}
      >
        <SiRedux className="skills-card-img" fontSize={40} /* Reduced font size */ />
      ...
      <GridItem
        ...
        _hover={{ color: '#1976d2', cursor: 'pointer' }}
      >
        <IoLogoNodejs className="skills-card-img" fontSize={40} /* Reduced font size */ />
      ...
      <Box w={'fit-content'} m={'auto'} >
        ...
        <Grid fontSize={20} textAlign={'center'} templateColumns={['repeat(1, 1fr)', 'repeat(2, 1fr)', 'repeat(3, 1fr)']} gap={6} w={'fit-content'} m={'auto'}>
          <GridItem m={10} outline={'2px solid #1976d2'} p={3} borderRadius={10} style={{ boxShadow: 'rgba(0, 0, 0, 0.35) 0px 5px 15px', }} _hover={{ color: '#1976d2', cursor: 'pointer' }} >
            <Img src={vscode} />
            <Text>Vscode</Text>
          </GridItem>
          <GridItem m={10} outline={'2px solid #1976d2'} p={3} borderRadius={10} style={{ boxShadow: 'rgba(0, 0, 0, 0.35) 0px 5px 15px', }} _hover={{ color: '#1976d2', cursor: 'pointer' }} >
